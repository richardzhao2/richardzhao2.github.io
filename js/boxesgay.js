...
window.onload = function run() {
  ...
  var engeeLabelText = document.getElementById("label1text");
  var engeeBackGround = document.getElementById("engeepic")
  ...
  engee.addEventListener("mousemove", function (event) {
    ...
    */
    ...
    sizingRatio = -125 / 31 * currentDistance + 562;
    var xOffset = Math.abs(sizingRatio - 187) / 2
    $(engee).css({
      position: 'relative',
      left: "-" + xOffset + "px",
      top: "-" + xOffset + "px"
    });
    //barSizingRatio = (-1/93 * currentDistance + 15);
    //textSizingRatio = (93/-14 * -1/93 * currentDistance + 2);

    //console.log(sizingRatio);

    engee.style.width = sizingRatio + "px";
    engee.style.height = sizingRatio + "px";
    engee.style.zIndex = "1";

    //engeeBackGround.style.transform = "scale(" + 1/sizingRatio + ")";

    //engeeLabel.style.transform = "scale(" + 1/sizingRatio * barSizingRatio + ")";
    //engeeLabel.style.zIndex = "2";

    // engeeLabelText.style.transform = "scale(" + textSizingRatio + ")";
    // engeeLabel.style.zIndex = "3";
